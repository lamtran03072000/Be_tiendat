  ...
  async translateWithProxies(text, toLanguage) {
    try {
      let data = await axios.post(
        'https://script.google.com/macros/s/AKfycbxyvJjxdh8Gpi2Sm_CgSKbFpYk0h-xCUz_YV6zLKk--H2orWqpN3taVGquHjmtn1DOiUA/exec',
        {
          source: text,
          target: toLanguage,
          lg: 'vi',
      ...
      const dataParse = JSON.parse(data.data.translatedText);
      return dataParse;
    } catch (error) {
